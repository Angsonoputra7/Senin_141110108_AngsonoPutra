...
namespace latihan_pos
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into product.product(product_Id,`product_nama`,`product_initial_amount`,`product_selling_price`,`product_selling_price`)values(" + this.textBox1.Text + "," + this.textBox3.Text + "," + this.textBox4.Text + "," + this.textBox5.Text + "," + this.textBox6.Text + ");";
